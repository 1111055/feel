...
<head>
    ...
    <title>FEELBIT - Digital Marketing.</title>
    ...
    <header class="navbar navbar-inverse navbar-fixed-top" role="banner">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><img src="img/logotipo/logo55.png" alt="Basica"></a>
            </div>
...
<hr>
        ...
        <div class="footer">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="footer-copyright">&copy; 2017 <a href="#">FeelBit</a> <a href="#">Digital Marketing</a>.</div>
                    </div>
                </div>
            </div>
        </div>
